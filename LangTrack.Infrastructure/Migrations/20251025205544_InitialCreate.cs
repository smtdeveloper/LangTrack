        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Meaning = table.Column<string>(type: "TEXT", maxLength: 512, nullable: false),
                    Example = table.Column<string>(type: "TEXT", maxLength: 512, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudiedAtUtc = table.Column<DateTime>(type: "TEXT", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudyLogs_Words_WordId",
                        column: x => x.WordId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudyLogs_StudiedAtUtc",
                table: "StudyLogs",
                column: "StudiedAtUtc");
